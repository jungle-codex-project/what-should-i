...
WhatShouldI는 취향, 현재 상황, 날씨, 트렌드를 함께 반영해 하루의 선택을 추천하는 Flask 기반 라이프스타일 대시보드입니다. 음식, 패션, 콘텐츠, 활동 추천을 각각 따로 분리하지 않고 하나의 사용자 프로필과 행동 피드백 위에서 연결합니다.
